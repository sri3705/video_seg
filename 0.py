...
class Network:
    ...
    def createEmbeddingNetwork(self, database_list_path='.', batch_size=20, phase=0):
		...
		#self.net.
        self.net.target_norm = l2normed(self.net.inner_product_target, inner_product_output)
        self.net.negative_norm = l2normed(self.net.inner_product_negative, inner_product_output)
        self.net.context_norm = l2normed(self.net.context_sum, inner_product_output)
		#Target - Negative
